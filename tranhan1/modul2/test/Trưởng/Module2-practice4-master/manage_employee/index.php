...
<div class="container">
    <a href="create.php">
        <button class="btn btn-primary mt-3 mb-1">Add new</button>
    </a>
    <div class="card">
            ...
            <table class="table">
                ...
                <?php foreach ($employee as $key => $employee): ?>
                    <tr>
                        ...
                        <td><a href="edit.php?index=<?php echo $key ?>" type="button" class="btn btn-warning">EDIT</a>
                        </td>
                        <td><a onclick="return confirm('Are you sure???')" href="delete.php?index=<?php echo $key ?>"
